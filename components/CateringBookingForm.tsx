  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
      <div className="space-y-6">
        ...
        <div className="bg-stone-800/70 border-2 border-red-700/50 rounded-lg p-6 shadow-xl">
      ...
      <div className="bg-stone-800/70 border-2 border-red-700/50 rounded-lg p-8 shadow-xl">
        ...
        {success && (
          <div className="mb-6 p-4 bg-green-900/30 border-2 border-green-700/50 rounded-lg">
            <p className="text-green-300 font-semibold">
              Thank you! Your catering request has been submitted. We&apos;ll contact you shortly.
            </p>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label htmlFor="catering-name" className="block text-orange-300 font-semibold mb-2">
              Your Name *
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="catering-email" className="block text-orange-300 font-semibold mb-2">
              Email Address *
            </label>
            <input
              type="email"
          ...
          <div>
            <label htmlFor="catering-phone" className="block text-orange-300 font-semibold mb-2">
              Phone Number *
            </label>
            <input
              type="tel"
          ...
          <div>
            <label htmlFor="catering-eventDate" className="block text-orange-300 font-semibold mb-2">
              Event Date *
            </label>
            <input
              type="date"
          ...
          <div>
            <label htmlFor="catering-eventType" className="block text-orange-300 font-semibold mb-2">
              Event Type *
            </label>
            <select
          ...
          <div>
            <label htmlFor="catering-guestCount" className="block text-orange-300 font-semibold mb-2">
              Number of Guests *
            </label>
            <input
              type="number"
          ...
          <div>
            <label htmlFor="catering-message" className="block text-orange-300 font-semibold mb-2">
              Additional Details
            </label>
            <textarea
              id="catering-message"
              ...
              placeholder="Tell us about your event, menu preferences, or special requests..."
            />
          </div>
          ...
          <p className="text-stone-400 text-sm text-center">* Required fields</p>
        </form>
      </div>
    </div>
  );
