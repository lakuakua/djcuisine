...
export default function CheckoutPage() {
  ...
  const shippingTotalCents = selectedRate
    ...
    : 0;
  const orderTotalCents = subtotal + shippingTotalCents;
    ...
    <div className="min-h-screen bg-stone-950">
      ...
      <main className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
        ...
        <p className="mb-8 text-sm text-stone-400">
          Enter your delivery address, get live UPS rates via Easyship, then pay securely with
          Stripe.
        </p>
        ...
        <div className="space-y-6 rounded-xl border border-red-900/40 bg-gradient-to-br from-stone-900 to-black p-6 shadow-xl">
          ...
          <div className="border-t border-red-900/40 pt-4">
            ...
            <div className="flex justify-between text-lg font-bold text-white">
              ...
              <span className="bg-gradient-to-r from-red-400 to-orange-400 bg-clip-text text-transparent">
                {selectedRate ? formatPrice(orderTotalCents) : formatPrice(subtotal)}
              </span>
            </div>
          </div>
          ...
          <button
            type="button"
            onClick={pay}
            disabled={payLoading || hasGallonMinimumIssue || !selectedService}
